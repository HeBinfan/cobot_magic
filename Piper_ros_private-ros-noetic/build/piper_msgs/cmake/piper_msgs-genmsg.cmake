...
message(STATUS "piper_msgs: 2 messages, 0 services")

set(MSG_I_FLAGS "-Ipiper_msgs:/home/agilex/cobot_magic/Piper_ros_private-ros-noetic/src/piper_msgs/msg;-Iactionlib_msgs:/opt/ros/noetic/share/actionlib_msgs/cmake/../msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/agilex/cobot_magic/Piper_ros_private-ros-noetic/src/piper_msgs/msg/PiperStatusMsg.msg" NAME_WE)
add_custom_target(_piper_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "piper_msgs" "/home/agilex/cobot_magic/Piper_ros_private-ros-noetic/src/piper_msgs/msg/PiperStatusMsg.msg" ""
)

get_filename_component(_filename "/home/agilex/cobot_magic/Piper_ros_private-ros-noetic/src/piper_msgs/msg/PosCmd.msg" NAME_WE)
add_custom_target(_piper_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "piper_msgs" "/home/agilex/cobot_magic/Piper_ros_private-ros-noetic/src/piper_msgs/msg/PosCmd.msg" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/piper_msgs)
  install(CODE "execute_process(COMMAND \"/home/agilex/miniconda3/envs/aloha/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/piper_msgs\")")
  # install generated code
  install(
